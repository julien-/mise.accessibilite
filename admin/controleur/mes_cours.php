...
<div class="tabbable"> 
    <ul class="nav nav-tabs">
        <li class="<?php if (!isset($_GET['r'])) echo "active";?>"><a href="#gestion" data-toggle="tab">Gestion de mes cours</a></li>
        <li class="<?php if (isset($_GET['r'])) echo "active";?>"><a href="#recherche" data-toggle="tab">Recherche d'étudiant</a></li>
    </ul>

    <div class="tab-content">
        <div class="tab-pane <?php if (!isset($_GET['r'])) echo "active";?>" id="gestion">
            <!--DIV Sous onglet 1-->
