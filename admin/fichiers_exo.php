...
if (isset($_GET["exo_sel"]) || isset($_GET['ex'])) {
    ...
    $rq_fichiers = mysql_query("SELECT id_fichier, chemin_fichier, nom, commentaires, code_lien, enligne " .
            "FROM " . $tb_fichiers . " " .
            "WHERE id_exo = " . $id_exo);
        ...
        <table class="tableau">
            ...
            <tbody>
                ...
                while ($mon_fichier = mysql_fetch_assoc($rq_fichiers)) {
                    ?>
                    <tr class="trFICHIER autre_colonne">
