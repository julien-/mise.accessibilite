		...
		<div class="row">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">
							<i class="fa fa-line-chart"></i> Visites de ce cours sur les 7
							derniers jours
						</h3>
					</div>
			...
			<div class="col-lg-6 center-content">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">
							<i class="fa fa-pie-chart"></i> Progression globale de l'étudiant
						</h3>
					</div>
					<div class="panel-body">
						<div id="morris-area-chart">
...
?>
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">
							...
							actualit&eacute;s liées à ce cours
						</h3>
					</div>
					<div class="panel-body">
    ...
    <?php
				...
				foreach ( $listeThemes as $theme ) {
					$progression = $daoAvancement->getByThemeEtudiant($theme->getId(), $_GET['e']);
					?>
                <tr>
