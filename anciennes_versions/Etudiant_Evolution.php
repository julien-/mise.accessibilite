...
if ($id_cours != false)
{
    ...
    $consignes = "
                        ...
                        <table>
                            ...
                            <tr>
                                <td style=\"background-color: green; width: 20%; border: 1px solid black;\">
                            ...
                            <tr>
                                <td style=\"background-color: orange; width: 20%; border: 1px solid black;\">
                            ...
                            <tr>
                                <td style=\"background-color: red; width: 20%; border: 1px solid black;\">
    ...
    <table class="accueil" style=" height:<?php echo $hauteur."px";?>;">
    ...
    ?>
                <tr class="accueil_theme" style="width: <?php echo $taille_div."%;";?>">  
    <?php
                    $var ++;
                    $hauteur_escalier1=(int)(($hauteur)/$row['Nbexos']);
                    $hauteur_escalier=(int)(($hauteur)/$row['Nbexos']);
    ...
    <?php
                            if($i == $nb_fait && $i != $row['Nbexos'])
                                echo "<img src=\"../images/homme_avance.png\"/ style=\"position: absolute; display: block;\">";
                            elseif($i == $nb_fait && $i == $row['Nbexos'] && $i != $nb_assimile)
                                echo "<img src=\"../images/homme_drapeau.png\"/ style=\"position: absolute; display: block; width: 30px; height: 30px;\">";
                            elseif($i == $nb_fait && $i == $row['Nbexos'] && $i == $nb_assimile)
                                echo "<img src=\"../images/homme_joyeux.png\"/ style=\"position: absolute; display: block; width: 30px; height: 30px;\">";
    ...
    ?>
                            ...
                            <div <?php echo "id=barre_".$i;?> style="background-color: <?php echo $background;?>; margin-top: 30px; width: 28px; height: <?php echo $hauteur_escalier."px;";?>; border: 1px solid black;">
                            </div>
                        </td>                 
     <?php
