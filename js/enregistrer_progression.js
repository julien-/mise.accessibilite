$(document).ready(function() {
    ...
    $("#etudiants").change(function() {
     ...
     $(".note").change(function() {
                    var idbonus = "input[name=bonus_suivi" + $(this).attr('value') + "]";
                    if (!$(idbonus).is(':checked')) 
                    {
                        var option = "select[name=note" + $(this).attr('value') + "]";
                        $(option).val(-1);
                        $("#bloc_page").append('<div class="erreur">Vous devez cocher la case suivi avant de donner une note</div>');
                        //cache l'erreur
    ...
    $(".bonus_suivi").click(function() { 
        var checked = "input[id=bonus_suivi" + $(this).val() + "]";
        if(!$(checked).is(':checked') )
        {
            var option = "select[name=note" + $(this).val() + "]";
            $(option).val(-1);
        }
    });
